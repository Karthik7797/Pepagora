...
export default function CatalogOverviewPage() {
  ...
  return (
    <div className={s.wrapper}>
      ...
      {/* Address of the generated site — mobile only, per the design. */}
      <p className={s.siteUrl}>
        www.pepagora.com/<span className={s.siteSlug}>autogenerated_site</span>
      </p>

      <div className={s.layout}>
        <CatalogTabs preview={preview} />
      ...
      {/* Actions dock to the bottom of the viewport on mobile. */}
      <div className={s.bottomBar}>
        <Button variant="outline" pill fullWidth>
          View site
        </Button>
        <Link href={ROUTES.editor('home')} className={s.bottomBarLink}>
          <Button variant="primary" pill fullWidth iconRight="arrow-right">
            Edit Template
          </Button>
        </Link>
      </div>
